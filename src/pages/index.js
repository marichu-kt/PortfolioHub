...
// Cargar planeta dinámicamente solo en cliente
    ...
    <div className="relative h-screen w-screen overflow-hidden bg-[#0d1117] text-white">
      <div className="relative z-10 h-full w-full flex flex-col items-center justify-center text-center px-8 gap-24">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <Link href="/dashboard">
            <button className="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium shadow-lg transition transform hover:scale-105 text-white">
              Go to Dashboard
            </button>
          </Link>
